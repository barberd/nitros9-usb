...
*   2025/02/25 Don Barber - put back in external 'KeyDrv' if EXTERNKEYDRV define
*              is set, mainly for use with external USB keyboard driver.
*              Added logic to allow both external and built-in keyboards to
*              coexists.
